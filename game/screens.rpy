...
screen input_name():
    ...
    frame:
        background Frame("images/inventory/paper.png", 25, 25)
        xalign 0.5
        yalign 0.5
        xsize 700
        ysize 250
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton "Boy":
                    ...
                    text_yalign 0.5
                    background "#3b2412"
                    hover_background "#5a3920"
                    text_color "#f5e6c8"

                    action [
                        SetVariable("player_gender", "boy"),
                        Return()
                    ]
                ...
                textbutton "Girl":
                    ...
                    action [
                        SetVariable("player_gender", "girl"),
                        Return()
                    ]

## In Game Options Button ###############################################################

screen options_button():

    zorder 210

    imagebutton:
        idle "icon_options"
        hover "icon_options_hover"
        xalign 0.98
        yalign 0.03
        xsize 116
        ysize 114
...
screen choice(items):
    ...
    vbox:
        ...
        if menu_question:
            frame:
                background Frame("gui/bg-question.png")
                xalign 0.5
                xpadding 250
                ypadding 85
                text menu_question:
        ...
        hbox:
            ...
            for i in items:
                if i.action:
                    $ finder = i.caption[i.caption.find("(")+1:i.caption.find(")")]
                    $ clean_caption = i.caption.replace(" (%s)" % finder, "")
                    $ img = finder if finder else ""

                    $ completed = (
                        (img == "ch_library" and finished_library)
                        or
                        (img == "ch_cellar" and finished_cellar)
                        or
                        (img == "ch_kitchen" and finished_kitchen)
                    )
...
screen main_menu():
    ...
    vbox:
        ...
        if main_menu:
            imagebutton:
                idle Transform("gui/menu_button/start.png", zoom=1.0)
                hover Transform("gui/menu_button/start.png", zoom=1.1)
                action Start()
                xalign 0.5
        ...
        imagebutton:
                idle Transform("gui/menu_button/load.png", zoom=1.0)
                hover Transform("gui/menu_button/load.png", zoom=1.1)
                action ShowMenu("load")
                xalign 0.5

        imagebutton:
                idle Transform("gui/menu_button/options.png", zoom=1.0)
                hover Transform("gui/menu_button/options.png", zoom=1.1)
                action ShowMenu("preferences")
                xalign 0.5
        ...
        # imagebutton:
        #     idle Transform("gui/menu_button/quit.png", zoom=1.0)
        #     hover Transform("gui/menu_button/quit.png", zoom=1.1)
...
style main_menu_frame:
    ...
    background "images/main_menu.jpg"
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Language")
                    textbutton "English" text_font "fonts/SpecialElite.ttf" action Language(None)
                    textbutton "Indonesian" text_font "fonts/SpecialElite.ttf" action Language("id_zenpy")
